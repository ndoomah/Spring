  ...
  Foundation.libs.topbar = {
    ...
    init : function (section, method, options) {
      ...
      self.S('[' + this.attr_name() + ']', this.scope).each(function () {
        ...
        topbar.data('index_original.xhtml', 0);
    ...
    events : function (bar) {
      ...
      S(this.scope)
        ...
        .on('click.fndtn.topbar', '[' + this.attr_name() + '] .has-dropdown>a', function (e) {
          if (self.breakpoint()) {
            ...
            topbar.data('index_original.xhtml', topbar.data('index_original.xhtml') + 1);
            $selectedLi.addClass('moved');

            if (!self.rtl) {
              section.css({left: -(100 * topbar.data('index_original.xhtml')) + '%'});
              section.find('>.name').css({left: 100 * topbar.data('index_original.xhtml') + '%'});
            } else {
              section.css({right: -(100 * topbar.data('index_original.xhtml')) + '%'});
              section.find('>.name').css({right: 100 * topbar.data('index_original.xhtml') + '%'});
            }
      ...
      S(this.scope).on('click.fndtn.topbar', '[' + this.attr_name() + '] .has-dropdown .back', function (e) {
        ...
        if (topbar.data('index_original.xhtml') === 0) {
          topbar.css('height', '');
        } else {
