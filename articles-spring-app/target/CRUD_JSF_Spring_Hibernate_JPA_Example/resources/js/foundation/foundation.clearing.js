  ...
  Foundation.libs.clearing = {
    ...
    shift : function (current, target, callback) {
      var clearing = target.parent(),
          old_index = this.settings.prev_index || target.index_original(),
      ...
      if (target.index_original() !== old_index && !/skip/.test(direction)){
        ...
        skip_shift = target.index_original() - this.settings.up_count;
        this.lock();
    ...
    direction : function ($el, current, target) {
      var lis = this.S('li', $el),
          ...
          target_index = lis.index_original(target),
          response;
